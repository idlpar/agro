...
class PaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('export')) {
            // Ensure the export uses the same filtered query as the display
            return $this->exportPayments($payments->get());
        }
    ...
    public function create(Request $request)
    {
        ...
        $prefill_amount = $request->input('amount');

        return view('payments.create', compact('customers', 'selected_customer_id', 'prefill_amount'));
    }
    ...
    public function customerTransactions(User $customer)
    {
        ...
        $totalDueBalance = $customer->transactions->sum('due_amount');

        return view('payments.customer-transactions', compact('customer', 'transactions', 'totalDueBalance'));
    }
}
