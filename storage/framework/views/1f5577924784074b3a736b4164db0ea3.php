<div id="toast-container" class="fixed bottom-4 right-4 space-y-3 z-50 max-w-xs" role="alert">
    <?php if(session('success')): ?>
        ...
        >
            ...
            <span class="ml-3 text-sm"><?php echo e(session('success')); ?></span>
    ...
    <?php elseif(session('status') === 'profile-updated'): ?>
        ...
        >
            ...
            <span class="ml-3 text-sm"><?php echo e(__('Profile successfully updated.')); ?></span>
            <button @click="show = false" class="ml-auto p-1 hover:bg-gray-100 rounded-full" aria-label="Close">
                <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M6 18L18 6M6 6l12 12"/>
    ...
    <?php elseif(session('status') === 'password-updated'): ?>
        ...
        >
            ...
            <span class="ml-3 text-sm"><?php echo e(__('Password successfully updated.')); ?></span>
            <button @click="show = false" class="ml-auto p-1 hover:bg-gray-100 rounded-full" aria-label="Close">
                <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M6 18L18 6M6 6l12 12"/>
    ...
    <?php elseif(session('error')): ?>
        ...
        >
            ...
            <span class="ml-3 text-sm"><?php echo e(session('error')); ?></span>
            <button @click="show = false" class="ml-auto p-1 hover:bg-gray-100 rounded-full" aria-label="Close">
                <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M6 18L18 6M6 6l12 12"/>
...
<?php /**PATH C:\laragon\www\agro\resources\views/components/toast.blade.php ENDPATH**/ ?>