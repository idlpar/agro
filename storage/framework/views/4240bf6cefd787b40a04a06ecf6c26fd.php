...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <nav class="flex items-center space-x-2 text-sm mt-1">
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-indigo-500 hover:text-indigo-700">
            ...
            <div class="flex space-x-2">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('payments.dueList')); ?>"
     ...
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('Payments')); ?> | <?php echo e(config('app.name')); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow mb-4">
                <div class="p-3 border-b border-gray-200">
                    <form method="GET" action="<?php echo e(route('payments.index')); ?>" class="space-y-3">
                        <!-- First Row - Main Filters -->
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-2">
                            <!-- Customer -->
                            <div>
                                <label for="customer_id" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('Customer')); ?></label>
                            ...
                            <!-- Receiver -->
                            <div>
                                <label for="receiver_id" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('Received By')); ?></label>
                                <select id="receiver_id" name="receiver_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs h-8">
                                    ...
                                    <?php $__currentLoopData = $receivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $receiver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($receiver->id); ?>" <?php echo e(request('receiver_id') == $receiver->id ? 'selected' : ''); ?>>
                            ...
                            <!-- Status -->
                            <div>
                                <label for="status" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('Status')); ?></label>
                                <select id="status" name="status" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs h-8">
                                    <option value=""><?php echo e(__('All')); ?></option>
                                    <option value="allocated" <?php echo e(request('status') === 'allocated' ? 'selected' : ''); ?>><?php echo e(__('Allocated')); ?></option>
                                    <option value="unallocated" <?php echo e(request('status') === 'unallocated' ? 'selected' : ''); ?>><?php echo e(__('Unallocated')); ?></option>
                                </select>
                            </div>

                            <!-- Date Range -->
                            <div>
                                <label for="date_range" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('Date')); ?></label>
                                <select id="date_range" name="date_range" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs h-8">
                                    <option value=""><?php echo e(__('All Time')); ?></option>
                                    <option value="today" <?php echo e(request('date_range') === 'today' ? 'selected' : ''); ?>><?php echo e(__('Today')); ?></option>
                                    <option value="this_week" <?php echo e(request('date_range') === 'this_week' ? 'selected' : ''); ?>><?php echo e(__('This Week')); ?></option>
                                    <option value="this_month" <?php echo e(request('date_range') === 'this_month' ? 'selected' : ''); ?>><?php echo e(__('This Month')); ?></option>
                                    <option value="custom" <?php echo e(request('date_range') === 'custom' ? 'selected' : ''); ?>><?php echo e(__('Custom')); ?></option>
                                </select>
                            </div>

                            <!-- Search -->
                            <div>
                                <label for="search" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('Search')); ?></label>
                        ...
                        <div id="custom_date_range" class="grid grid-cols-1 md:grid-cols-3 gap-2 <?php echo e(request('date_range') === 'custom' ? '' : 'hidden'); ?>">
                            <div>
                                <label for="start_date" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('From')); ?></label>
                            ...
                            <div>
                                <label for="end_date" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('To')); ?></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                            <div>
                                <label for="amount_min" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('Min Amount')); ?></label>
                                <input type="number" step="0.01" min="0" name="amount_min" id="amount_min" value="<?php echo e(request('amount_min')); ?>"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs h-8"
                                       placeholder="<?php echo e(__('Min')); ?>">
                            </div>
                            <div>
                                <label for="amount_max" class="block text-xs font-medium text-gray-700 mb-1"><?php echo e(__('Max Amount')); ?></label>
                                <input type="number" step="0.01" min="0" name="amount_max" id="amount_max" value="<?php echo e(request('amount_max')); ?>"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-xs h-8"
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-2">
                            ...
                            <div class="flex items-center space-x-4 text-2xs">
                                <div class="flex items-center">
                                    <span class="text-gray-500 mr-1"><?php echo e(__('Total:')); ?></span>
                                    <span class="font-medium"><?php echo e($payments->total()); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <span class="text-gray-500 mr-1"><?php echo e(__('Amount:')); ?></span>
                                    <span class="font-medium"><?php echo e(number_format($totalAmount, 2)); ?> Tk</span>
                                </div>
                                <div class="flex items-center">
                                    <span class="text-gray-500 mr-1"><?php echo e(__('Discount:')); ?></span>
                                    <span class="font-medium"><?php echo e(number_format($totalDiscount, 2)); ?> Tk</span>
                                </div>
                                <div class="flex items-center">
                                    <span class="text-gray-500 mr-1"><?php echo e(__('Allocated:')); ?></span>
                                    <span class="font-medium text-green-600"><?php echo e(number_format($totalAllocated, 2)); ?> Tk</span>
                                </div>
                                <div class="flex items-center">
                                    <span class="text-gray-500 mr-1"><?php echo e(__('Unallocated:')); ?></span>
                                    <span class="font-medium text-amber-600"><?php echo e(number_format($totalUnallocated, 2)); ?> Tk</span>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            <th scope="col" class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'payment_date', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])); ?>" class="flex items-center">
                                    <?php echo e(__('Date')); ?>

                                    <?php if(request('sort') === 'payment_date'): ?>
                            ...
                            <th scope="col" class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => 'amount', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])); ?>" class="flex items-center">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <div class="text-xs text-gray-900"><?php echo e($payment->payment_date->format('d M Y')); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($payment->payment_date->format('h:i A')); ?></div>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-6 w-6 rounded-full bg-indigo-100 flex items-center justify-center text-xs text-indigo-600">
                                            <?php echo e(strtoupper(substr($payment->customer->name, 0, 1))); ?>

                                        </div>
                                        <div class="ml-2">
                                            <div class="text-2xs font-medium text-gray-900 truncate max-w-[120px]"><?php echo e($payment->customer->name); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap text-xs font-medium text-gray-900">
                                    <?php echo e(number_format($payment->amount, 2)); ?> Tk
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap text-xs font-medium text-gray-900">
                                    <?php echo e(number_format($payment->discount_amount, 2)); ?> Tk
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap text-xs text-gray-500">
                                    <?php echo e(number_format($payment->transactions->sum('pivot.allocated_amount'), 2)); ?> Tk
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 flex items-center justify-center text-xs text-blue-600">
                                            <?php echo e(strtoupper(substr($payment->receiver->name, 0, 1))); ?>

                                        </div>
                                        <div class="ml-2">
                                            <div class="text-2xs font-medium text-gray-900 truncate max-w-[120px]"><?php echo e($payment->receiver->name); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-2 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-2xs leading-4 font-semibold rounded-full <?php echo e($payment->transactions->count() ? 'bg-green-100 text-green-800' : 'bg-amber-100 text-amber-800'); ?>">
                                        <?php echo e($payment->transactions->count() ? 'Allocated' : 'Unallocated'); ?>
                                ...
                                <td class="px-4 py-2 whitespace-nowrap text-right text-lg font-medium">
                                    <div class="flex items-center justify-end space-x-1">
                                        <a href="<?php echo e(route('payments.show', $payment->id)); ?>"
                                           class="text-indigo-600 hover:text-indigo-900 p-1" title="<?php echo e(__('View')); ?>">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $payment)): ?>
                                            <a href="<?php echo e(route('payments.edit', $payment->id)); ?>"
                                               class="text-blue-600 hover:text-blue-900 p-1" title="<?php echo e(__('Edit')); ?>">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $payment)): ?>
                                            <form action="<?php echo e(route('payments.destroy', $payment->id)); ?>" method="POST" class="inline delete-form">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="text-red-600 hover:text-red-900 p-1" title="<?php echo e(__('Delete')); ?>">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="7" class="px-4 py-4 text-center text-xs text-gray-500">
                                    <?php echo e(__('No payments found')); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\agro\resources\views/payments/index.blade.php ENDPATH**/ ?>