        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <nav class="flex items-center space-x-2 text-sm mt-2">
                    ...
                    <span class="text-gray-600">{{ __('Due List') }}</span>
                </nav>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('payments.visitList') }}"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-red-600 mt-1">{{ number_format($totalDueAmount, 2) }} Tk</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-yellow-600 mt-1">{{ number_format($averageDue, 2) }} Tk</p>
                        </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ $customer->transactions_count }} total
                                        </div>
                                        <div class="text-xs text-gray-500">
                                            {{ $customer->paid_transactions_count }} paid
                                        </div>
                                    </td>
