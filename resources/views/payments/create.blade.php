                                ...
                                <select id="user_id" name="user_id" required
                                    ...
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->id }}"
                                            ...
                                            {{ (old('user_id') == $customer->id || (isset($selected_customer_id) && $selected_customer_id == $customer->id)) ? 'selected' : '' }}>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative rounded-lg shadow-sm">
                                        ...
                                        <input type="text" step="0.01" min="0.01" id="amount" value="{{ old('amount', isset($prefill_amount) ? $prefill_amount : '') }}" required
                                        ...
                                        <input type="hidden" id="amount_hidden" name="amount" value="{{ old('amount', isset($prefill_amount) ? $prefill_amount : '') }}">
