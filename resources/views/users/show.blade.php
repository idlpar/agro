            ...
            <div class="bg-white overflow-hidden shadow rounded-xl">
                ...
                <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-blue-50">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500">{{ ucfirst($user->role) }} • Joined {{ $user->created_at->format('F Y') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="bg-gray-50 p-5 rounded-lg shadow-sm">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900 font-medium">{{ $user->phone ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Account Information -->
                        <div class="bg-gray-50 p-5 rounded-lg shadow-sm">
                            <h4 class="text-lg font-medium text-gray-900 mb-4 pb-2 border-b border-gray-200">{{ __('Account Information') }}</h4>
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-500">{{ __('User Role') }}</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-500">{{ __('Account Created') }}</label>
                                    <p class="mt-1 text-sm text-gray-900 font-medium">{{ $user->created_at->format('M d, Y \a\t h:i A') }}</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-500">{{ __('Last Updated') }}</label>
                                    <p class="mt-1 text-sm text-gray-900 font-medium">{{ $user->updated_at->format('M d, Y \a\t h:i A') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Additional Sections -->
                    <div class="mt-6 bg-gray-50 p-5 rounded-lg shadow-sm">
                        <h4 class="text-lg font-medium text-gray-900 mb-4 pb-2 border-b border-gray-200">{{ __('Activity') }}</h4>
                        <p class="text-sm text-gray-500">{{ __('User activity and statistics can be displayed here.') }}</p>
                    </div>
                </div>
            </div>
        </div>
